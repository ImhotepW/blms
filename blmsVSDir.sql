...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TYPE "BLMS"."IDS_T" 
AS TABLE OF NUMBER;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TYPE "BLMS"."LUX_T" AS OBJECT 
( 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TYPE "BLMS"."LUX_TABLE" 
AS TABLE OF LUX_T
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TYPE "BLMS"."TOP_T" IS 
OBJECT (
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE TYPE "BLMS"."TOP_TABLE" IS TABLE OF top_t
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "BLMS"."CLUB_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 81 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence CONTRACT_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "BLMS"."CONTRACT_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 821 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence LEAGUE_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "BLMS"."LEAGUE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence PLAYER_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "BLMS"."PLAYER_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1041 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence POSITION_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "BLMS"."POSITION_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence SEASON_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "BLMS"."SEASON_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Sequence TRADE_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "BLMS"."TRADE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE  NOPARTITION ;
--------------------------------------------------------
--  DDL for Table BUDGET
--------------------------------------------------------

  CREATE TABLE "BLMS"."BUDGET" 
   (	"LEAGUE_ID" NUMBER(*,0), 
	"SEASON_ID" NUMBER(*,0), 
	"AMOUNT" NUMBER(*,0)
   ) ;

   COMMENT ON TABLE "BLMS"."BUDGET"  IS 'Budget amount of each League for all the Seasons';
--------------------------------------------------------
--  DDL for Table CLUB
--------------------------------------------------------

  CREATE TABLE "BLMS"."CLUB" 
   (	"ID" NUMBER(*,0), 
	"NAME" VARCHAR2(128 CHAR)
   ) ;

   COMMENT ON TABLE "BLMS"."CLUB"  IS 'The team which takes part in the game';
--------------------------------------------------------
--  DDL for Table CONTRACT
--------------------------------------------------------

  CREATE TABLE "BLMS"."CONTRACT" 
   (	"ID" NUMBER(*,0), 
	"CLUB_ID" NUMBER(*,0), 
	"PLAYER_ID" NUMBER(*,0), 
   ...
   COMMENT ON TABLE "BLMS"."CONTRACT"  IS 'Agreement of the Player to play for the Club for specific reason';
--------------------------------------------------------
--  DDL for Table LEAGUE
--------------------------------------------------------

  CREATE TABLE "BLMS"."LEAGUE" 
   (	"ID" NUMBER(*,0), 
	"SHORT_NAME" VARCHAR2(8 CHAR), 
	"FULL_NAME" VARCHAR2(128 CHAR)
   ) ;

   COMMENT ON TABLE "BLMS"."LEAGUE"  IS 'Lists all the possible Leagues';
--------------------------------------------------------
--  DDL for Table LEAGUE_SEASON_CLUB_REL
--------------------------------------------------------

  CREATE TABLE "BLMS"."LEAGUE_SEASON_CLUB_REL" 
   (	"SEASON_ID" NUMBER(*,0), 
	"LEAGUE_ID" NUMBER(*,0), 
	"CLUB_ID" NUMBER(*,0)
   ) ;

   COMMENT ON TABLE "BLMS"."LEAGUE_SEASON_CLUB_REL"  IS 'Defines which Season is Contract for';
--------------------------------------------------------
--  DDL for Table LUXURY_TAX
--------------------------------------------------------

  CREATE TABLE "BLMS"."LUXURY_TAX" 
   (	"DATE_MONTH" DATE, 
	"LEAGUE_ID" NUMBER(*,0), 
	"CLUB_ID" NUMBER(*,0), 
	"THE_TAX" NUMBER
...
--------------------------------------------------------
  ...
  CREATE TABLE "BLMS"."PLAYER" 
   (	"ID" NUMBER(*,0), 
	"NAME" VARCHAR2(128 CHAR), 
	"IS_INJURED" NUMBER(1,0) DEFAULT 0
   ) ;

   COMMENT ON TABLE "BLMS"."PLAYER"  IS 'All possible players that have ever played any of the leagues';
--------------------------------------------------------
--  DDL for Table PLAYER_POSITION_REL
--------------------------------------------------------

  CREATE TABLE "BLMS"."PLAYER_POSITION_REL" 
   (	"PLAYER_ID" NUMBER(*,0), 
	"POSITION_ID" NUMBER(*,0)
   ) ;

   COMMENT ON TABLE "BLMS"."PLAYER_POSITION_REL"  IS 'Specific Position that Player is playing in for the team (Club)';
--------------------------------------------------------
--  DDL for Table POSITION
--------------------------------------------------------

  CREATE TABLE "BLMS"."POSITION" 
   (	"ID" NUMBER(*,0), 
	"SHORT_NAME" VARCHAR2(8 CHAR), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "BLMS"."SEASON" 
   ...
   COMMENT ON TABLE "BLMS"."SEASON"  IS 'Dictionary of the Seasons';
--------------------------------------------------------
--  DDL for Table TRADE
--------------------------------------------------------

  CREATE TABLE "BLMS"."TRADE" 
   (	"TRADE_ID" NUMBER(*,0), 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "BLMS"."V_LUXURY_TAX" ("SEASON_ID", "SEASON_YEAR", "LEAGUE_ID", "LEAGUE_NAME", "CLUB_ID", "CLUB_NAME", "THE_TAX") AS 
  WITH team_budget as (
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "BLMS"."V_TEAM_OUT_OF_BUDGET" ("SEASON_YEAR", "CLUB_NAME") AS 
  SELECT season_year,
       club_name
  FROM v_luxury_tax;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "BLMS"."V_TOP_10_PLAYERS" ("PLAYER_NAME", "BUDGET") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "BLMS"."V_TOP_10_TEAMS" ("CLUB_NAME", "BUDGET") AS 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "BLMS"."POSITION_PK" ON "BLMS"."POSITION" ("ID") 
  ;
--------------------------------------------------------
--  DDL for Index CONTRACT_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "BLMS"."CONTRACT_PK" ON "BLMS"."CONTRACT" ("ID") 
  ;
--------------------------------------------------------
--  DDL for Index PLAYER_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "BLMS"."PLAYER_PK" ON "BLMS"."PLAYER" ("ID") 
  ;
--------------------------------------------------------
--  DDL for Index CONTRACT_CLUB_PLAYER_INDX
--------------------------------------------------------

  CREATE INDEX "BLMS"."CONTRACT_CLUB_PLAYER_INDX" ON "BLMS"."CONTRACT" ("CLUB_ID", "PLAYER_ID") 
  ;
--------------------------------------------------------
--  DDL for Index LUXURY_TAX_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "BLMS"."LUXURY_TAX_PK" ON "BLMS"."LUXURY_TAX" ("LEAGUE_ID", "CLUB_ID", "DATE_MONTH") 
  ;
--------------------------------------------------------
--  DDL for Index PLAYER_POSITION_REL_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "BLMS"."PLAYER_POSITION_REL_PK" ON "BLMS"."PLAYER_POSITION_REL" ("PLAYER_ID", "POSITION_ID") 
  ;
--------------------------------------------------------
--  DDL for Index LEAGUE_SEASON_CLUB_REL_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "BLMS"."LEAGUE_SEASON_CLUB_REL_PK" ON "BLMS"."LEAGUE_SEASON_CLUB_REL" ("SEASON_ID", "LEAGUE_ID", "CLUB_ID") 
  ;
--------------------------------------------------------
--  DDL for Index CLUB_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "BLMS"."CLUB_PK" ON "BLMS"."CLUB" ("ID") 
  ;
--------------------------------------------------------
--  DDL for Index LEAGUE_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "BLMS"."LEAGUE_PK" ON "BLMS"."LEAGUE" ("ID") 
  ;
--------------------------------------------------------
--  DDL for Index BUDGET_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "BLMS"."BUDGET_PK" ON "BLMS"."BUDGET" ("LEAGUE_ID", "SEASON_ID") 
  ;
--------------------------------------------------------
--  DDL for Index TRADE_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "BLMS"."TRADE_PK" ON "BLMS"."TRADE" ("TRADE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index SEASON_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "BLMS"."SEASON_PK" ON "BLMS"."SEASON" ("ID") 
  ;
--------------------------------------------------------
--  Constraints for Table POSITION
--------------------------------------------------------

  ALTER TABLE "BLMS"."POSITION" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."POSITION" ADD CONSTRAINT "POSITION_PK" PRIMARY KEY ("ID")
  USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table BUDGET
--------------------------------------------------------

  ALTER TABLE "BLMS"."BUDGET" ADD CONSTRAINT "BUDGET_PK" PRIMARY KEY ("LEAGUE_ID", "SEASON_ID")
  USING INDEX  ENABLE;
  ALTER TABLE "BLMS"."BUDGET" MODIFY ("LEAGUE_ID" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."BUDGET" MODIFY ("SEASON_ID" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."BUDGET" MODIFY ("AMOUNT" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table CONTRACT
--------------------------------------------------------

  ALTER TABLE "BLMS"."CONTRACT" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."CONTRACT" MODIFY ("CLUB_ID" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."CONTRACT" MODIFY ("PLAYER_ID" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."CONTRACT" MODIFY ("DATE_START" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."CONTRACT" MODIFY ("VALUE" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."CONTRACT" ADD CONSTRAINT "CONTRACT_PK" PRIMARY KEY ("ID")
  USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table LEAGUE
--------------------------------------------------------

  ALTER TABLE "BLMS"."LEAGUE" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."LEAGUE" ADD CONSTRAINT "LEAGUE_PK" PRIMARY KEY ("ID")
  USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table SEASON
--------------------------------------------------------

  ALTER TABLE "BLMS"."SEASON" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."SEASON" MODIFY ("YEAR" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."SEASON" MODIFY ("DATE_START" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."SEASON" MODIFY ("DATE_END" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."SEASON" MODIFY ("TEAM_SIZE" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."SEASON" ADD CONSTRAINT "SEASON_PK" PRIMARY KEY ("ID")
  USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table PLAYER
--------------------------------------------------------

  ALTER TABLE "BLMS"."PLAYER" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."PLAYER" ADD CONSTRAINT "PLAYER_PK" PRIMARY KEY ("ID")
  USING INDEX  ENABLE;
  ALTER TABLE "BLMS"."PLAYER" ADD CONSTRAINT "PLAYER_INJURED_CHK" CHECK (is_injured IN (0, 1)) ENABLE;
--------------------------------------------------------
--  Constraints for Table PLAYER_POSITION_REL
--------------------------------------------------------

  ALTER TABLE "BLMS"."PLAYER_POSITION_REL" MODIFY ("PLAYER_ID" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."PLAYER_POSITION_REL" MODIFY ("POSITION_ID" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."PLAYER_POSITION_REL" ADD CONSTRAINT "PLAYER_POSITION_REL_PK" PRIMARY KEY ("PLAYER_ID", "POSITION_ID")
  USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table LUXURY_TAX
--------------------------------------------------------

  ALTER TABLE "BLMS"."LUXURY_TAX" MODIFY ("LEAGUE_ID" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."LUXURY_TAX" MODIFY ("CLUB_ID" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."LUXURY_TAX" MODIFY ("DATE_MONTH" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."LUXURY_TAX" ADD CONSTRAINT "LUXURY_TAX_PK" PRIMARY KEY ("LEAGUE_ID", "CLUB_ID", "DATE_MONTH")
  USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table TRADE
--------------------------------------------------------

  ALTER TABLE "BLMS"."TRADE" MODIFY ("TRADE_ID" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."TRADE" ADD CONSTRAINT "TRADE_PK" PRIMARY KEY ("TRADE_ID")
  USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table CLUB
--------------------------------------------------------

  ALTER TABLE "BLMS"."CLUB" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."CLUB" ADD CONSTRAINT "CLUB_PK" PRIMARY KEY ("ID")
  USING INDEX  ENABLE;
--------------------------------------------------------
--  Constraints for Table LEAGUE_SEASON_CLUB_REL
--------------------------------------------------------

  ALTER TABLE "BLMS"."LEAGUE_SEASON_CLUB_REL" MODIFY ("SEASON_ID" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."LEAGUE_SEASON_CLUB_REL" MODIFY ("LEAGUE_ID" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."LEAGUE_SEASON_CLUB_REL" MODIFY ("CLUB_ID" NOT NULL ENABLE);
  ALTER TABLE "BLMS"."LEAGUE_SEASON_CLUB_REL" ADD CONSTRAINT "LEAGUE_SEASON_CLUB_REL_PK" PRIMARY KEY ("SEASON_ID", "LEAGUE_ID", "CLUB_ID")
  USING INDEX  ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table BUDGET
--------------------------------------------------------

  ALTER TABLE "BLMS"."BUDGET" ADD CONSTRAINT "BUDGET_LEAGUE_FK" FOREIGN KEY ("LEAGUE_ID")
	  REFERENCES "BLMS"."LEAGUE" ("ID") ENABLE;
  ALTER TABLE "BLMS"."BUDGET" ADD CONSTRAINT "BUDGET_SEASON_FK" FOREIGN KEY ("SEASON_ID")
	  REFERENCES "BLMS"."SEASON" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CONTRACT
--------------------------------------------------------

  ALTER TABLE "BLMS"."CONTRACT" ADD CONSTRAINT "CONTRACT_CLUB_FK" FOREIGN KEY ("CLUB_ID")
	  REFERENCES "BLMS"."CLUB" ("ID") ENABLE;
  ALTER TABLE "BLMS"."CONTRACT" ADD CONSTRAINT "CONTRACT_PLAYER_FK" FOREIGN KEY ("PLAYER_ID")
	  REFERENCES "BLMS"."PLAYER" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table LEAGUE_SEASON_CLUB_REL
--------------------------------------------------------

  ALTER TABLE "BLMS"."LEAGUE_SEASON_CLUB_REL" ADD CONSTRAINT "LEAGUE_SEASON_CLUB_CLUB_FK" FOREIGN KEY ("CLUB_ID")
	  REFERENCES "BLMS"."CLUB" ("ID") ENABLE;
  ALTER TABLE "BLMS"."LEAGUE_SEASON_CLUB_REL" ADD CONSTRAINT "LEAGUE_SEASON_CLUB_LEAGUE_FK" FOREIGN KEY ("LEAGUE_ID")
	  REFERENCES "BLMS"."LEAGUE" ("ID") ENABLE;
  ALTER TABLE "BLMS"."LEAGUE_SEASON_CLUB_REL" ADD CONSTRAINT "LEAGUE_SEASON_CLUB_SEASON_FK" FOREIGN KEY ("SEASON_ID")
	  REFERENCES "BLMS"."SEASON" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table LUXURY_TAX
--------------------------------------------------------

  ALTER TABLE "BLMS"."LUXURY_TAX" ADD CONSTRAINT "LUXURY_TAX_CLUB_FK" FOREIGN KEY ("CLUB_ID")
	  REFERENCES "BLMS"."CLUB" ("ID") ENABLE;
  ALTER TABLE "BLMS"."LUXURY_TAX" ADD CONSTRAINT "LUXURY_TAX_LEAGUE_FK" FOREIGN KEY ("LEAGUE_ID")
	  REFERENCES "BLMS"."LEAGUE" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table PLAYER_POSITION_REL
--------------------------------------------------------

  ALTER TABLE "BLMS"."PLAYER_POSITION_REL" ADD CONSTRAINT "PLPOS_PLAYER_FK" FOREIGN KEY ("PLAYER_ID")
	  REFERENCES "BLMS"."PLAYER" ("ID") ENABLE;
  ALTER TABLE "BLMS"."PLAYER_POSITION_REL" ADD CONSTRAINT "PLPOS_POSITION_FK" FOREIGN KEY ("POSITION_ID")
	  REFERENCES "BLMS"."POSITION" ("ID") ENABLE;
--------------------------------------------------------
--  DDL for Trigger CLUB_ID_INCR
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "BLMS"."CLUB_ID_INCR" 
...
/
ALTER TRIGGER "BLMS"."CLUB_ID_INCR" ENABLE;
--------------------------------------------------------
--  DDL for Trigger CONTRACT_ID_INCR
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "BLMS"."CONTRACT_ID_INCR" 
...
/
ALTER TRIGGER "BLMS"."CONTRACT_ID_INCR" ENABLE;
--------------------------------------------------------
--  DDL for Trigger LEAGUE_ID_INCR
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "BLMS"."LEAGUE_ID_INCR" 
...
/
ALTER TRIGGER "BLMS"."LEAGUE_ID_INCR" ENABLE;
--------------------------------------------------------
--  DDL for Trigger PLAYER_ID_INCR
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "BLMS"."PLAYER_ID_INCR" 
...
/
ALTER TRIGGER "BLMS"."PLAYER_ID_INCR" ENABLE;
--------------------------------------------------------
--  DDL for Trigger POSITION_ID_INCR
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "BLMS"."POSITION_ID_INCR" 
...
/
ALTER TRIGGER "BLMS"."POSITION_ID_INCR" ENABLE;
--------------------------------------------------------
--  DDL for Trigger SEASON_ID_INCR
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "BLMS"."SEASON_ID_INCR" 
...
/
ALTER TRIGGER "BLMS"."SEASON_ID_INCR" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRADE_ID_INCR
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "BLMS"."TRADE_ID_INCR" 
...
/
ALTER TRIGGER "BLMS"."TRADE_ID_INCR" ENABLE;
--------------------------------------------------------
--  DDL for Package BLMS
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE "BLMS"."BLMS" AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "BLMS"."BLMS" AS 
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "BLMS"."INITIALIZE" AS 
BEGIN
  init_data;
  init_relations;
END INITIALIZE;
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "BLMS"."INIT_DATA" AS 
BEGIN
  -- Truncating tables
...
set define off;
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "BLMS"."INIT_RELATIONS" AS 
  pos_amt NUMBER(8, 0);
